...
public interface ISurveyQuestionGroupRepository extends IGenericRepository {
	...
	void updateGroupsToUnPinned(Long surveyId, Long surveyGroupId) throws FrameworkException;

	SurveyGroup getPinnedGroupBySurvey(Long surveyId) throws FrameworkException;
