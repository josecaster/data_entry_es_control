...
public class SurveyGroup extends MappedSuperClass {
	...
	@FilterFieldProperty(fieldProperty = SurveyGroupProperty.PINNED)
	@Column(name = EsControlTables.SURVEY_GROUPS_.COLUMNS.PINNED_)
	private Boolean pinned;
	
	@FilterFieldProperty(fieldProperty = SurveyGroupProperty.ENABLE_APPLICABILITY)
	@Column(name = EsControlTables.SURVEY_GROUPS_.COLUMNS.ENABLE_APPLICABILITY_)
